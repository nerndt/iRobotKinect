...
namespace iRobotKinect
{
    ...
    {
        private readonly Dictionary<string, WhatSaid> robotPhrases = new Dictionary<string, WhatSaid>
            {
                { "Left", new WhatSaid { Verb = Verbs.Left } },
                { "Right", new WhatSaid { Verb = Verbs.Right } },
                { "Forwards", new WhatSaid { Verb = Verbs.Forwards } },
                { "Back", new WhatSaid { Verb = Verbs.Back } },
                { "Backwards", new WhatSaid { Verb = Verbs.Backwards } },
                { "Reverse", new WhatSaid { Verb = Verbs.Reverse } },
                { "Halt", new WhatSaid { Verb = Verbs.Stop } },
                { "End", new WhatSaid { Verb = Verbs.Stop } },
        ...
        private void SreSpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            ...
            List<Dictionary<string, WhatSaid>> allDicts = new List<Dictionary<string, WhatSaid>> { robotPhrases}; // , this.gameplayPhrases, this.shapePhrases, this.colorPhrases, this.singlePhrases };
