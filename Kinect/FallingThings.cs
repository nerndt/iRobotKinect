...
//        public static Label MakeSimpleLabel(string text, Rectangle bounds, System.Drawing.Color color)
//        {
...
//                label.Location = new Point(bounds.Left, bounds.Top);
//                label.Width = bounds.Width;
//                label.Height = bounds.Height;
//            }

//            label.ForeColor = color;
//            label.Font = new System.Drawing.Font("Arial", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
//            return label;
//        }
...
//        public void SetBoundaries(Rectangle r)
//        {
//            this.sceneRect = r;
...
//                            {
//                                var hitCenter = new System.Drawing.Point(0, 0);
...
//        private void AddToScore(int player, int points, System.Drawing.Point center)
//        {
...
//                XVelocity = 0,
//                Shape = newShape,
//                Center = new System.Drawing.Point((this.rnd.NextDouble() * dropWidth) + ((this.sceneRect.Left + this.sceneRect.Right - dropWidth) / 2), this.sceneRect.Top - newSize),
...
//            {
//                points.Add(new System.Drawing.Point((Math.Cos(theta) * size) + center.X, (Math.Sin(theta) * size) + center.Y));
...
//            public bool Hit(Segment seg, ref System.Drawing.Point hitCenter, ref double lineHitLocation)
//            {
...
//                    {
//                        hitCenter.X = (int)seg.X1;
//                        hitCenter.Y = (int)seg.Y1;
//                        lineHitLocation = 0;
//                        return true;
//                    }
//                }
...
//                        {
//                            lineHitLocation = u;
//                            hitCenter.X = (int)intersectX;
//                            hitCenter.Y = (int)intersectY;
//                            return true;
//                        }
//                    }
//                    else
...
//                            {
//                                lineHitLocation = 1;
//                                hitCenter.X = (int)seg.X2;
//                                hitCenter.Y = (int)seg.Y2;
//                                return true;
//                            }
//                        }
//                    }
...
//                this.Center.X = (int)x0;
//                this.Center.Y = (int)y0;
//            }
//        }
//    }
//}
