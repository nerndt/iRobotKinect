...
namespace KinectWinforms.MaNet
{
 ...
 * ------------------------ */
   ...
   */
   ...
   ///<summary>Construct an m-by-1 matrix.</summary>
   ///<param name="m">Number of rows.</param>
   ///<param name="s">Fill the matrix with this double array.</param>
