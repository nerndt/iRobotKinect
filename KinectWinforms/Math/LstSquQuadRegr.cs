...
namespace KinectWinforms
{
    ...
    */
    ...
    //ArrayList trendLinePointArrayList = new ArrayList();
    //LstSquQuadRegr linearRegressionTrendLineAndRSquared = new LstSquQuadRegr(pointArrayList);
    //double slope, yIntercept;
    //linearRegressionTrendLineAndRSquared.calculateTrendLineEquationPointArrayAndRSquared(pointArrayList, ref trendLinePointArrayList, out RSquared, out slope, out yIntercept);
    ////
